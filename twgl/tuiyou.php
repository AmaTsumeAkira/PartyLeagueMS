...
<script src="../tabler/dist/js/demo-theme.min.js?1684106062"></script>
    ...
    if (isset($_POST['tuihui_student'])) {
      ...
      // 执行更新语句
      $query = "UPDATE tystu SET classid='$class_id', stuid='$stuid', name='$name', mz='$mz', sex='$sex', idcard='$idcard', zhiwu='$zhiwu', dizhi='$dizhi', jihuaid='$jihuaid', xueli='$xueli', jiguan='$jiguan', chushengriqi='$chushengriqi', rutuannianyue='$rutuannianyue', peiyangren1='$peiyangren1', peiyangren2='$peiyangren2', shenqingrudangriqi='$shenqingrudangriqi', jijifenzi='$jijifenzi', fazhan='$fazhan', yubei='$yubei', zhuanzheng='$zhuanzheng', zhuangtai='0', beizhu='$beizhu' WHERE id=$id";
      $result = mysqli_query($conn, $query);
      if ($result) {
          echo "学生退回成功";
      } else {
...
if ($result->num_rows > 0) {
    ...
    exit();
                ...
                <ul class="steps steps-green steps-counter my-4">
                    ...
                    <li class="step-item active">团务审核</li>
                ...
                <div class="row row-cards">
                    <div class="col-md">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title" _msttexthash="10570118" _msthash="241">待审核</h3>
                            </div>
                            <table class='table table-vcenter card-table center'>
    <tr>
        <!-- <th>ID</th> -->
        <th>班级</th>
        <!-- <th>学号</th> -->
    ...
    $jihuaid = $row["id"];
    $query_students = "SELECT * FROM tystu WHERE zhuangtai = 1 AND jihuaid = $jihuaid;";
...
echo "</table>";
    ...
    ?>
                    ...
                    <div class="col-md">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title" _msttexthash="10584678" _msthash="242">待党务审核</h3>
                            </div>
                            <table class="table">
    <tr>
        <!-- <th>ID</th> -->
    ...
    ?>
                    ...
                    <div class="col-md">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title" _msttexthash="10571054" _msthash="243">该批次推荐成功</h3>
                            </div>
                            <table class="table">
    <tr>
        <!-- <th>ID</th> -->
    ...
    $row = $result->fetch_assoc();
    $jihuaid = $row["id"];
    $query_students = "SELECT * FROM tystu WHERE zhuangtai = 4 AND jihuaid = $jihuaid;";
    $result_students = mysqli_query($conn, $query_students);
    while($row = mysqli_fetch_assoc($result_students)) {
        echo "<tr>";
        //echo "<td>{$row['id']}</td>";
...
<div class="col-md-12">
        ...
        <small class="form-hint">格式：学院职务（没有不填）+团支部书记评语+可选团委评语<br>若审核不通过说明不通过原因</small>
    </div>
</div> 
        ...
        <div class="modal-footer">
            ...
            <input type="submit" name="tuihui_student" value="审核不通过" class="btn btn-red me-auto"> 
            <input type="submit" name="edit_student" value="审核通过" class="btn btn-green"> 
...
<!-- 修改学生结束 -->
    ...
    <script>
        function editStudent(id, classId, stuid, name, mz, sex, idcard, zhiwu, dizhi, jihuaid, xueli, jiguan, chushengriqi, rutuannianyue, peiyangren1, peiyangren2, shenqingrudangriqi, jijifenzi, fazhan, yubei, zhuanzheng, zhuangtai, beizhu) {
            ...
            document.getElementById('edit_zhuangtai').value = 2;
