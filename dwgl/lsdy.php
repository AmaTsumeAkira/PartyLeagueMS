...
// 查询符合条件的学生数据
$query_students = "SELECT * FROM tystu WHERE zhuangtai > 7 ";
                  ...
                  <div class="mb-3">
                    ...
                    <div class="col">
                      ...
                      <small class="form-hint">格式必须是：XXXX年X月<br>如：2015年8月、2015年12月</small>
				  				  				                    ...
				  				  				                    <div class="mb-3">
                    <label class="col-5 col-form-label required">积极分子计划ID</label>
                    <div class="col">
