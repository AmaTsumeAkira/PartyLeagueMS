            ...
            <div class="row row-cards">
              <div class="col-lg-8">
                <div class="card card-lg table-responsive">
                  ...
                  <table class="table table table-vcenter card-table" id="dataTable">
    <tr>
        <!-- <th>ID</th>
        <th>班级</th> -->
        <th>学号</th>
...
// 查询符合条件的学生数据
$query_students = "SELECT * FROM tystu WHERE zhuangtai > 3 ";
...
?>
              ...
              <form method="post" class="card">
                <div class="card-header">
                  <h3 class="card-title">添加新积极分子</h3>
                </div>
                <div class="card-body">
                  <div class="mb-3">
...
if(mysqli_num_rows($result_tzb) > 0) {
    ...
    // 使用classid查询class表以获取班级信息
    $query_class = "SELECT id, username FROM class WHERE password = '未毕业'";
    $result_class = mysqli_query($conn, $query_class);
                  ...
                  <div class="mb-3">
                    ...
                    <div class="col">
                      ...
                      <small class="form-hint">格式必须是：XXXX年X月<br>如：2015年8月、2015年12月</small>
				  				                    ...
				  				                    <div class="mb-3">
                    <label class="col-3 col-form-label required">积极分子计划ID</label>
                    <div class="col">
                      <input type="text" name="jihuaid" class="form-control" placeholder="XXXX年X月" required>
                      <small class="form-hint">计划ID去推优页面察看</small>
                    </div>
                  </div>
                </div>
...
<!-- 修改学生开始 -->
      ...
      <form method="post">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">修改积极分子信息</h5>
    ...
    <div class="mb-3">
        <label class="col-10 col-form-label required">选择班级(仅显示未毕业班级)</label>
                    <div class="col">
